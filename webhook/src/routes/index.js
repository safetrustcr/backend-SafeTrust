...
const authRoutes              = require('./auth').default || require('./auth')
const apartmentRoutes         = require('./apartments/list.route').default || require('./apartments/list.route')
const bidRequestsRoute        = require('./bid-requests')
const reservationsRoute       = require('./reservations').default || require('./reservations')
