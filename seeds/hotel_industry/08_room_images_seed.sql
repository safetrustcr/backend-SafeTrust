...
-- Idempotency: delete only demo seed images by known URLs before re-inserting
DELETE FROM hotel_industry.room_images
WHERE (image_url, uploaded_at) IN (
    ('https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800', '2024-07-15 10:30:00+00'),
    ('https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?w=800', '2024-07-15 10:35:00+00'),
    ('https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=800', '2024-07-15 10:40:00+00'),
    ('https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800', '2024-07-16 14:20:00+00'),
    ('https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800', '2024-07-16 14:25:00+00'),
    ('https://images.unsplash.com/photo-1568495248636-6432b97bd949?w=800', '2024-07-18 09:15:00+00'),
    ('https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=800', '2024-07-18 09:20:00+00'),
    ('https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=800', '2024-07-18 09:25:00+00')
);
